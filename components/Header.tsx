	...
	return (
		<header className="max-w-full">
			<div className="flex mx-auto justify-between items-center max-w-[1228px] py-4">
				<a href="/"><div className="flex items-center gap-3 px-[70px] bg-no-repeat bg-[url(../app/cache/Logo.svg)] min-h-[30px]"></div></a>
				<nav className="hidden sm:inline-block">
					<ul className="flex lg:gap-[30px]">
						<li className="font-regular text-xl text-black"><a href="/#/profile">Новости</a></li>
				...
				<div className="lg:gap-9">
					<button className="font-regular text-l text-black border border-black rounded-[64px] md:py-2 lg:py-2 md:px-4 lg:px-16">Войти</button>
				</div>
			</div>
